...
(function () {
  ...
  const translations = {
    pt: {
      ...
      'hero.desc': 'Empréstimos a juros, pagamento parcelado, aluguel de casas e quartos, aluguel de veículos: tudo em um só lugar. Use dados e IA para gerir como um profissional — sem planilhas, sem caos.',
      'hero.cta': 'Conheça a plataforma',
      ...
      'problem.6': 'Sem alertas de atraso: cliente atrasa e você só descobre depois',
      ...
      'assets.title': 'Um hub para seus principais ativos',
      'assets.loans': 'Empréstimos a juros',
      'assets.installments': 'Pagamento parcelado',
      'assets.realestate': 'Aluguel de casas e quartos',
      'assets.vehicles': 'Aluguel de veículos',
      'goal1.title': 'Profissionalizar a gestão',
      'goal1.desc': 'Centralize empréstimos a juros, pagamento parcelado, aluguéis e renegociações. Visão clara de quem paga, quem atrasa e quanto rende.',
      ...
      'goal4.desc': 'Alertas de atraso e inadimplência, antecipação de problemas e redução de perdas. Cresça de forma sustentável e controlada.',
      ...
      'feature1': 'Empréstimos a juros e pagamento parcelado',
      'feature2': 'Painel consolidado de ativos e rentabilidade',
      'feature3': 'Análise de risco e projeções com IA',
      'feature4': 'Alertas de atraso e inadimplência',
      'feature4.desc': 'Avisos de pagamentos em atraso, vencimentos próximos e clientes em risco. Nunca perca o controle.',
      ...
      'preview.lead': 'Interface moderna para empréstimos a juros, pagamento parcelado, aluguel de imóveis e de veículos. Controle, alertas e rentabilidade em um só lugar.',
    ...
    en: {
      ...
      'hero.desc': 'Interest-based loans, installment payments, house and room rentals, vehicle rentals: all in one place. Use data and AI to manage like a pro — no spreadsheets, no chaos.',
      'hero.cta': 'See the platform',
      ...
      'problem.6': 'No delay alerts: you only find out when a client is late',
      ...
      'assets.title': 'One hub for your main assets',
      'assets.loans': 'Interest-based loans',
      'assets.installments': 'Installment payments',
      'assets.realestate': 'House and room rentals',
      'assets.vehicles': 'Vehicle rentals',
      'goal1.title': 'Professionalize management',
      'goal1.desc': 'Centralize interest-based loans, installment payments, rentals, and renegotiations. Clear view of who pays, who defaults, and how much it yields.',
      ...
      'goal4.desc': 'Alerts for delays and default, early warning on problems, and loss reduction. Grow in a sustainable, controlled way.',
      ...
      'feature1': 'Interest-based loans and installment payments',
      'feature2': 'Consolidated assets and profitability dashboard',
      'feature3': 'Risk analysis and AI-powered projections',
      'feature4': 'Alerts for delays and default',
      'feature4.desc': 'Overdue payments, upcoming due dates, and clients at risk. Never lose control.',
      ...
      'preview.lead': 'Modern interface for interest-based loans, installment payments, real estate and vehicle rentals. Control, alerts, and profitability in one place.',
